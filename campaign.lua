...
function maxed()
    ...
    P2_deck_cards[5] = 'AhsokaTanoFulcrum'
    P2_deck_cards[6] = 'AhsokaTanoS7'
    P2_deck_cards[7] = 'CountDooku'
    P2_deck_cards[8] = 'AnakinSkywalkerROTS'
    P2_deck_cards[9] = 'LukeSkywalkerROTJ'
    P2_deck_cards[10] = 'ObiWanKenobi'
    P2_deck_cards[11] = 'Maul'
