function endor(number)
    ...
    if number == 1 then return {'Paploo',60,4} end
...
function maxedDarkSide(number)
    ...
    if number == 0 then return {'Darth Marr',60,4} end
    if number == 1 then return {'Grand Inquisitor',60,4} end
    if number == 2 then return {'Darth Vader',60,4} end
    if number == 3 then return {'Darth Sion',60,4} end
    if number == 4 then return {'Ninth Sister',60,4} end
    if number == 5 then return {'Count Dooku',60,4} end
    if number == 6 then return {'Seventh Sister',60,4} end
    if number == 7 then return {'Darth Malgus',60,4} end
    if number == 8 then return {'Darth Revan',60,4} end
    if number == 9 then return {'Emperor Palpatine',60,4} end
    if number == 10 then return {'Supreme Leader Snoke',60,4} end
    if number == 11 then return {'Darth Bane',60,4} end
    if number == 12 then return {'Fifth Brother',60,4} end
    if number == 13 then return {'Darth Nihilus',60,4} end
    if number == 14 then return {'The Son',60,4} end
    if number == 15 then return {'Sith Eternal Emperor',60,4} end
    if number == 16 then return {'Trilla Suduri',60,4} end
    if number == 17 then return {'Eighth Brother',60,4} end
end
...
function maxedLightSide(number)
    ...
    if number == 1 then return {'Hermit Luke Skywalker',60,4} end
    if number == 2 then return {'Jedi Knight Revan',60,4} end
    if number == 3 then return {'Yoda',60,4} end
    if number == 4 then return {'Ahsoka Tano Mandalorian',60,4} end
    if number == 5 then return {'Ahsoka Tano S7',60,4} end
    ...
    if number == 10 then return {'Hermit Yoda',60,4} end
    if number == 11 then return {'Jedi Master Obi-Wan Kenobi',60,4} end
    if number == 12 then return {'Visas Marr',60,4} end
    if number == 13 then return {'Kit Fisto',60,4} end
    if number == 14 then return {'The Daughter',60,4} end
    if number == 15 then return {'Kreia',60,4} end
    if number == 16 then return {'Quinlan Vos',60,4} end
    if number == 17 then return {'Atris',60,4} end
end

function maxed(number)
    if number == 'max' then return 18 end

    if number == 0 then return {'Darth Vader',60,4} end
    if number == 1 then return {'Yoda',60,4} end
    if number == 2 then return {'Jedi Knight Revan',60,4} end
    if number == 3 then return {'Zillo Beast',60,4} end
    if number == 4 then return {'Mace Windu',60,4} end
    if number == 5 then return {'Ahsoka Tano S7',60,4} end
    if number == 6 then return {'Jedi Knight Anakin Skywalker',60,4} end
    if number == 7 then return {'Emperor Palpatine',60,4} end
    if number == 8 then return {'The Father',60,4} end
    if number == 9 then return {'Darth Revan',60,4} end
    if number == 10 then return {'Hermit Luke Skywalker',60,4} end
    if number == 11 then return {'Meetra Surik',60,4} end
    if number == 12 then return {'Darth Nihilus',60,4} end
    if number == 13 then return {'The Daughter',60,4} end
    if number == 14 then return {'The Son',60,4} end
    if number == 15 then return {'Force Priestess',60,4} end
    if number == 16 then return {'Sith Eternal Emperor',60,4} end
    if number == 17 then return {'Bendu',60,4} end
end