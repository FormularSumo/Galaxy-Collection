...
function CampaignState:enter()
    ...
    local background
    if random == 1 then
        dathomirBackground = 'Dathomir Swamps'
    else
        dathomirBackground = 'Dathomir Plains'
    end
    ...
    gui[3] = Button(function() gStateMachine:change('GameState',{'Star Destroyer Command Bridge', 'Imperial March Piano.oga', imperialCommand}) end,'Imperial Command',font80,nil,'centre',40+130*1,{1,1,1},true)
    gui[4] = Button(function() gStateMachine:change('GameState',{'Sand Dunes', 'Binary Sunset.oga', mosEisley}) end,'Mos Eisley',font80,nil,'centre',40+130*2,{1,1,1},true)
    ...
    gui[9] = Button(function() gStateMachine:change('GameState',{dathomirBackground, 'Fallen Order.oga', dathomir}) end,'Dathomir',font80,nil,'centre',40+130*7,{1,1,1},true)
