...
function CampaignState:init()
    ...
    gui[3] = Button(loadBattle,{'Sand Dunes', true, 2, 0, 0, 0, 'Binary Sunset.oga', mosEisley},'Mos Eisley',font80,nil,'centre',170,1,1,1,true)
    gui[4] = Button(loadBattle,{'Sand Dunes', true, 2, 0, 0, 0, 'Throne Room.oga', mosEspa},'Mos Espa',font80,nil,'centre',300,1,1,1,true)
    ...
    gui[7] = Button(loadBattle,{'Sand Dunes', true, 2, 0, 0, 0, 'Clone Wars Theme.oga', geonosis},'Geonosis',font80,nil,'centre',690,1,1,1,true)
    ...
    gui[10] = Button(loadBattle,{'Sand Dunes', true, 2, 0, 0, 0, 'Binary Sunset.oga', maxedDarkSide},'Maxed Dark Side',font80,nil,'centre',1080,1,1,1,true)
