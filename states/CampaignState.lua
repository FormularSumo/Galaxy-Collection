...
function CampaignState:init()
    ...
    gui[9] = Button(function() loadBattle('Voss', nil, 0, 1, 1, 1, 'The Mandalorian.oga', maxedLightSide) end,'Maxed Light Side',font80,nil,'centre',950,1,1,1,true)
    gui[10] = Button(function() loadBattle('Sand Dunes', true, 2, 0, 0, 0, 'Binary Sunset.oga', maxedDarkSide) end,'Maxed Dark Side',font80,nil,'centre',1080,1,1,1,true)
    gui[11] = Button(function() loadBattle('Belsavis', nil, 0, 0, 0 ,0, 'Throne Room.oga', maxed) end,'Maxed',font80,nil,'centre',1210,1,1,1,true)
end
