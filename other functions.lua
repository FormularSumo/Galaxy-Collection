...
function tutorial()
    ...
    P1deckEdit(1,{'R2-D2',60,4},true)
    P1deckEdit(2,{'Farmboy Luke Skywalker',60,4},true)
    P1deckEdit(3,{'C-3PO',60,4},true)
    P1deckEdit(4,{'C-3PO',60,4},true)
    P1deckEdit(5,{'R2-D2',60,4},true)
    P1deckEdit(6,{'R2-D2',60,4},true)
    P1deckEdit(7,{'R2-D2',60,4},true)
    P1deckEdit(8,{'R2-D2',60,4},true)
    P1deckEdit(9,{'R2-D2',60,4},true)
    P1deckEdit(10,{'R2-D2',60,4},true)
    P1deckEdit(11,{'R2-D2',60,4},true)
    P1deckEdit(12,{'R2-D2',60,4},true)
    P1deckEdit(13,{'R2-D2',60,4},true)
    P1deckEdit(14,{'R2-D2',60,4},true)
    P1deckEdit(15,{'R2-D2',60,4},true)
    P1deckEdit(16,{'R2-D2',60,4},true)
    P1deckEdit(17,{'R2-D2',60,4},true)
    P1deckEdit(18,{'R2-D2',60,4},true)
    P1deckEdit(19,{'R2-D2',60,4},true)
    P1cardsEdit(20,{'R2-D2',60,4},true)
    P1cardsEdit(21,{'Grogu',60,4},true)
    P1cardsEdit(22,{'Grogu',60,4},true)
