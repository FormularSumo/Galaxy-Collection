...
function prebuilt_deck() --Doesn't belong here, will either be deleted or moved when I add deck editing
    ...
    P1_deck_edit(6,'KitFisto')
    P1_deck_edit(7,'ObiWanKenobi')
    P1_deck_edit(8,'HermitYoda')
    P1_deck_edit(9,'AhsokaTanoS7')
    P1_deck_edit(10,'JaroTapal')
    P1_deck_edit(11,'AgenKolar')
    P1_deck_edit(12,'BoKatan')
    P1_deck_edit(13,'NightsisterMerrin')
    P1_deck_edit(14,'Bendu')
    P1_deck_edit(15,'BobaFettMandalorian')
    P1_deck_edit(16,'TheMandalorian')
    P1_deck_edit(17,'KoskaReeves')
end