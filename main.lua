...
function love.touchmoved(id,x,y,dx,dy)
    if (yscroll > -maxScroll or dy > 0) and (yscroll < maxScroll or dy < 0) and (math.abs(dy) > 1.5 or touchLocked) then
        touchLocked = true
...
function love.wheelmoved(x,y)
    if (yscroll > -maxScroll or y > 0) and (yscroll < maxScroll or y < 0) then
...
function love.update(dt)
    ...
    --Smooth scrolling
    if (yscroll > -maxScroll or rawyscroll > 0) and (yscroll < maxScroll or rawyscroll < 0) and not touchDown then
