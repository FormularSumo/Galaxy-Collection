...
function RemoveCard:swap()
    ...
    P1deck[mouseTrapped.number].name, P1deck[mouseTrapped.number].level, P1deck[mouseTrapped.number].evolution, P1deck[mouseTrapped.number].imagePath, P1deck[mouseTrapped.number].image, P1deck[mouseTrapped.number].deleting = 'Blank', nil, nil, 'Graphics/Blank Card', gStateMachine.current.graphics['Graphics/Blank Card'], nil
