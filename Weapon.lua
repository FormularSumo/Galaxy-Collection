...
function Weapon:init(weapon,weapon2,weapon3,weapon4,weapon_count,team,xoffset,yoffset)
    ...
    self.short = self.image == Weapons['Dagger of Mortis'] or self.image == Weapons['Lightning'] or self.image == Weapons['Knife'] or self.image == Weapons['Flamethrower'] or self.image == Weapons['Truncheon'] or self.image == Weapons['Embo\'s Shield'] or self.image == Weapons['Tool 1'] or self.image == Weapons['Tool 2'] or self.image == Weapons['Kyuzo Petar'] or self.image == Weapons['Vine'] or self.image == Weapons['Sword'] or self.image == Weapons['Vibrosword'] or self.image == Weapons['Riot Control Baton'] or self.image == Weapons['Z6 Riot Control Baton'] or self.image == Weapons['Cane']
